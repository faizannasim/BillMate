...
function Home() {
  ...
  src={gir}
  alt="Background"
  className="absolute top-18 left-1/2 transform -translate-x-1/2 w-96 h-96 object-cover z-0 opacity-40"
...
/>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen  mx-auto  text-center ">
        <motion.h1 initial={{ opacity: 0, y: -40 }}
          ...
          transition={{ duration: 0.8, ease: "easeOut" }} className="text-3xl md:text-5xl font-light text-white font-stretch-extra-expanded"
          style={{
        ...
        >
          ...
          <span className="text-white font-stretch-extra-expanded font-light" style={{
            backgroundImage: `url(${car})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
            WebkitBackgroundClip: "text",
      ...
      <div className="bg-black mt-10 px-6 ">
        ...
        <div className=" w-full max-w-5xl    mx-auto mt-10 border-y border-dashed border-zinc-600  flex-col md:flex-row items-center gap-6 py-6 flex justify-center item-center ">
          ...
          <div className="flex flex-col items-center ">
            ...
            <motion.p
              className="text-8xl md:text-9xl font-stretch-extra-expanded px-8 py-4 rounded-lg"
            ...
            <br />
            <span className="  font-light inline-block bg-black tracking-wide  text-white font-stretch-extra-expanded text-lg mask-radial-from-neutral-900"> Invoices Reimagined</span>
          </div>
